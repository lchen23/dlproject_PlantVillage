# A convolutional neural network based plant disease detection system
   ...
   ## Instructions
All the steps for installing and importing required packages (with versions specified), downloading the dataset, training the model and analysing the results were described in detail in the jupyter notebook. To reproduce those results, one just need to re-run all the code cells in sequence.
